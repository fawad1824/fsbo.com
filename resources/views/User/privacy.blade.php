...
@section('content')
    ...
    <div class="container-fluid header bg-white p-0">
        <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
            <div class="col-md-6 p-5 mt-lg-5">
                <h1 class="display-5 animated fadeIn mb-4">Privacy Policy</h1>
                <nav aria-label="breadcrumb animated fadeIn">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item text-body active" aria-current="page">Privacy Policy</li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="container-xxl py-5 wow fadeInUp">
        <div class="container">
            ...
            <p>The words with initial capital letters have meanings defined under the following conditions. The
            ...
            <dl>
                ...
                <dt>Affiliate</dt>
                <dd>means an entity that controls, is controlled by, or is under common control with a party, where
                    "control" means ownership of 50% or more of the shares, equity interest, or other securities
                    entitled to vote for election of directors or other managing authority.</dd>

                <dt>Company</dt>
                <dd>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to fbso.com.
                </dd>

                <dt>Cookies</dt>
                <dd>are small files that are placed on Your computer, mobile device, or any other device by a website,
                    containing the details of Your browsing history on that website among its many uses.</dd>

                <dt>Country</dt>
                <dd>refers to: Pakistan</dd>

                <dt>Device</dt>
                <dd>means any device that can access the Service such as a computer, a cellphone, or a digital tablet.
                </dd>
                ...
                <dd>means any natural or legal person who processes the data on behalf of the Company. It refers to
                    ...
                    Company in analyzing how the Service is used.</dd>

                <dt>Third-party Social Media Service</dt>
                <dd>refers to any website or any social network website through which a User can log in or create an
                    account to use the Service.</dd>

                <dt>Usage Data</dt>
                <dd>refers to data collected automatically, either generated by the use of the Service or from the
                    Service infrastructure itself (for example, the duration of a page visit).</dd>

                <dt>Website</dt>
                <dd>refers to fbso.com, accessible from fbso.com.</dd>

                <dt>You</dt>
                <dd>means the individual accessing or using the Service, or the company, or other legal entity on behalf
                    of which such individual is accessing or using the Service, as applicable.</dd>
            </dl>
            ...
            <ul>
                <li>Cookies or Browser Cookies. A cookie is a small file placed on Your Device. You can instruct Your
                ...
                <li>Web Beacons. Certain sections of our Service and our emails may contain small electronic files known
            ...
            <ul>
                <li>Necessary / Essential Cookies: These Cookies are essential to provide You with services available
                    ...
                    for cannot be provided, and We only use these Cookies to provide You with those services.</li>
                <li>Cookies Policy / Notice Acceptance Cookies: These Cookies identify if users have accepted the use of
                    cookies on the Website.</li>
                <li>Functionality Cookies: These Cookies allow us to remember choices You make when You use the Website,
            ...
            <p>For more information about the cookies we use and your choices regarding cookies, please visit our <a
                    href="#">Cookies Policy</a> or the Cookies section of our Privacy Policy.</p>
            ...
            <ul>
                ...
                <li>With other users: when You share personal information or otherwise interact in the public areas with
                    ...
                    on the Third-Party Social Media Service may see Your name, profile, pictures, and description of
                    Your activity. Similarly, other users will be able to view descriptions of Your activity,
            ...
            <p>The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in
                ...
                our legal obligations, resolve disputes, and enforce our legal agreements and policies.</p>
            ...
            <ul>
                <li>By email: fsbo1122@gmail.com</li>
            </ul>
        </div>
    </div>
    <!-- 404 End -->
