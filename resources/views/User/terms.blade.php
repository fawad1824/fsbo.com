...
@section('content')
    ...
    <div class="container-fluid header bg-white p-0">
        <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
            <div class="col-md-6 p-5 mt-lg-5">
                <h1 class="display-5 animated fadeIn mb-4">Terms and Conditions</h1>
    ...
    <div class="container-xxl py-5 wow fadeInUp">
        <div class="container">
            ...
            <p>Welcome to FBSO.com!</p>

            <p>These terms and conditions outline the rules and regulations for the use of FBSO.com's Website, located
                at FBSO.com.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                FBSO.com if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
                ...
                prevailing law of pk. Any use of the above terminology or other words in the singular, plural,
                capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.
            </p>

            <h3><strong>Cookies</strong></h3>

            <p>We employ the use of cookies. By accessing FBSO.com, you agreed to use cookies in agreement with the
                FBSO.com's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, FBSO.com and/or its licensors own the intellectual property rights for all
                material on FBSO.com. All intellectual property rights are reserved. You may access this from FBSO.com
                for your own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from FBSO.com</li>
                <li>Sell, rent or sub-license material from FBSO.com</li>
                <li>Reproduce, duplicate or copy material from FBSO.com</li>
                <li>Redistribute content from FBSO.com</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. FBSO.com does not filter, edit, publish or review Comments prior to their
                presence on the website. Comments do not reflect the views and opinions of FBSO.com,its agents and/or
                affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
                the extent permitted by applicable laws, FBSO.com shall not be liable for the Comments or for any
            ...
            <p>FBSO.com reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant FBSO.com a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of FBSO.com; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to FBSO.com. Please include your name, your
            ...
            <p>No use of FBSO.com's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
