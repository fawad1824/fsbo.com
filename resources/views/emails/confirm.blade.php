...
<head>
    ...
    <style>
        ...
        .contain {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(90deg, #00B98E, #2f8198);
            background-image: linear-gradient(to bottom right, #00B98E, #02ccba);
        }
...
<body>
    <div class="contain">
        ...
        11.6,20 15.9,24.2 26.4,13.8 " />
            ...
            <div class="text">
                <p>Hi, {{ $user->name }}</p>
                <p>You have successfully Create Your Account<br>
                    Please Wait for Admin Approval<br>
                </p>
            </div>
            <p class="regards">Regards, <br> FBSO.com</p>
        </div>
    </div>
